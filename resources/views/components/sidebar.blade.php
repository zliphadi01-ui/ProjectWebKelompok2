    ...
    <ul class="sidebar-menu">
        ...
        <li>
            ...
            <div class="collapse {{ $isMaster ? 'show' : '' }}" id="masterDataMenu">
                <a href="{{ route('master-data.keadaan-akhir') }}" class="nav-link {{ request()->is('master-data/keadaan-akhir*') ? 'active' : '' }}">Keadaan Akhir</a>
                <a href="{{ route('master-data.menu') }}" class="nav-link {{ request()->is('master-data/menu*') ? 'active' : '' }}">Menu</a>
                <a href="{{ route('master-data.mitra') }}" class="nav-link {{ request()->is('master-data/mitra*') ? 'active' : '' }}">Mitra</a>
                <a href="{{ route('master-data.hak-akses') }}" class="nav-link {{ request()->is('master-data/hak-akses*') ? 'active' : '' }}">Hak Akses</a>
                <a href="{{ route('master-data.aktivasi-poli') }}" class="nav-link {{ request()->is('master-data/aktivasi-poli*') ? 'active' : '' }}">Aktivasi Poli</a>
                <a href="{{ route('master-data.pegawai') }}" class="nav-link {{ request()->is('master-data/pegawai*') ? 'active' : '' }}">Pegawai</a>
                <a href="{{ route('master-data.jadwal-poli') }}" class="nav-link {{ request()->is('master-data/jadwal-poli*') ? 'active' : '' }}">Jadwal Poli</a>
                <a href="{{ route('master-data.tindakan-laborat') }}" class="nav-link {{ request()->is('master-data/tindakan-laborat*') ? 'active' : '' }}">Tindakan &amp; Laborat</a>
                <a href="{{ route('master-data.icd10.index') }}" class="nav-link {{ request()->is('master-data/icd10*') ? 'active' : '' }}">Diagnosa ICD-10</a>
                <a href="{{ route('master-data.diagnosa') }}" class="nav-link {{ request()->is('master-data/diagnosa*') ? 'active' : '' }}">Diagnosa (Lama)</a>
                <a href="{{ route('master-data.kamar-rawat-inap') }}" class="nav-link {{ request()->is('master-data/kamar-rawat-inap*') ? 'active' : '' }}">Kamar Rawat Inap</a>
                <a href="{{ route('master-data.unit') }}" class="nav-link {{ request()->is('master-data/unit*') ? 'active' : '' }}">Unit</a>
                <a href="{{ route('master-data.vendor') }}" class="nav-link {{ request()->is('master-data/vendor*') ? 'active' : '' }}">Vendor</a>
                <a href="{{ route('master-data.kategori-diagnosa') }}" class="nav-link {{ request()->is('master-data/kategori-diagnosa*') ? 'active' : '' }}">Kategori Diagnosa</a>
                <a href="{{ route('master-data.jenis-pembayaran') }}" class="nav-link {{ request()->is('master-data/jenis-pembayaran*') ? 'active' : '' }}">Jenis Pembayaran</a>
                <a href="{{ route('master-data.profesi') }}" class="nav-link {{ request()->is('master-data/profesi*') ? 'active' : '' }}">Profesi</a>
                <a href="{{ route('master-data.resep-info') }}" class="nav-link {{ request()->is('master-data/resep-info*') ? 'active' : '' }}">Resep Info</a>
                <a href="{{ route('master-data.rs-rujukan') }}" class="nav-link {{ request()->is('master-data/rs-rujukan*') ? 'active' : '' }}">RS Rujukan</a>
            </div>
        </li>
        ...
        <li><a href="{{ url('/ubah-password') }}" class="nav-link {{ request()->is('ubah-password*') ? 'active' : '' }}"><i class="bi-key-fill"></i> <span>Ubah Password</span></a></li>
        <li><a href="{{ url('/pengaturan') }}" class="nav-link {{ request()->is('pengaturan*') ? 'active' : '' }}"><i class="bi-gear-fill"></i> <span>Pengaturan</span></a></li>
        <li><a href="{{ url('/pengaturan-grup') }}" class="nav-link {{ request()->is('pengaturan-grup*') ? 'active' : '' }}"><i class="bi-people-fill"></i> <span>Pengaturan Grup</span></a></li>
        <li><a href="{{ url('/bypass') }}" class="nav-link {{ request()->is('bypass*') ? 'active' : '' }}"><i class="bi-toggle-on"></i> <span>Bypass</span></a></li>
        <li><a href="{{ url('/whatsapp') }}" class="nav-link {{ request()->is('whatsapp*') ? 'active' : '' }}"><i class="bi-whatsapp"></i> <span>Whatsapp</span></a></li>
        @endif
